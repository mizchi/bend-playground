// Native C twin of p2.bend: breadth-first search over 2^DEPTH
// independent W x H grid mazes, single-threaded, 1-to-1 with the Bend
// program: same seed and
...
//   cc -std=c11 -O3 -DWB=5 -DHB=5 -DDEPTH=18 p2.c -o p2_c
#include <stdint.h>
#include <stdio.h>
#include <stdlib.h>
...
// one maze: fill the grid, seed the queue with cell 0 at distance 0,
// search, fold
